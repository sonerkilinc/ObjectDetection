...
while True:
    ...
    model = cv2.dnn.readNetFromDarknet(r"C:\Users\user\Desktop\python\YOLO Tutorial\pretrained_model\yolov3.cfg", r"C:\Users\user\Desktop\python\YOLO Tutorial\pretrained_model\yolov3.weights")
        ...
        for object_detection in detection_layer:
            ...
            if confidence > 0.35:  # güvenilir skor yüzde 30dan iyiyse bounding box çizeceğiz
                ...
                bounding_box = object_detection[0:4] * np.array(
                    [frame_width, frame_height, frame_width, frame_height])  # boyut ayarladık
    ...
    # 0.5 ve 0.4 treshold değerleri yani standart
    ...
    cv2.imshow("Real Time Object Detection v3", frame)
